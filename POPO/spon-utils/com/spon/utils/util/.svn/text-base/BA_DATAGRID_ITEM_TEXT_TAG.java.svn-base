...
public class BA_DATAGRID_ITEM_TEXT_TAG extends TagSupport{
	
	protected String name,id,disp_type,value="";
	...
	public int doStartTag() throws JspException {
		...
		if(iskey)
		{
			D_A.setDISP_TYPE("TK"+disp_type);
		}
		else
		{
			D_A.setDISP_TYPE("TN"+disp_type);
		}
