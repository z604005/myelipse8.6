 ...
 * <Form>讀取檔案內容的Form
 * @version 1.0
 * @created 26-六月-2006 下午 02:51:36
 */
public class BA_REPORTF extends ActionForm {
	...
	private FormFile up_file2;
	private String[] MUTI_STR;
	 ...
	 * @param o1
	 */
	public void reset(ActionMapping o0, HttpServletRequest o1){
	 ...
	 * @param o1
	 */
	public ActionErrors validate(ActionMapping o0, HttpServletRequest o1,Connection conn){
	...
	public FormFile getUp_file2() {
		return up_file2;
	}

	public void setUp_file2(FormFile up_file2) {
		this.up_file2 = up_file2;
	}
	...
	public String[] getMUTI_STR() {
		return MUTI_STR;
	}

	public void setMUTI_STR (String[] muti_str) {
		MUTI_STR = muti_str;
	}
