 ...
 */
public class EX030500R0F extends BA_EXCEL {
	 ...
	 * 
	*/
	public EX030500R0F(Connection conn,String rpt,String SC0030_01, int count) throws Exception{
			
		//樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
		super.TemplateName = "EHF030500R0_example.xls";
			
		//sheet的名稱
		super.SheetName = "臨時扣款表";
				
		//樣板一頁總列數
		super.PageRowCount = count + 3;
...
//		super.PageColCount = 10;
	 ...
	 * 
	 */
	public EX030500R0F(Connection conn,String rpt,String SC0030_01,HttpServletRequest request, int count) throws Exception{
