...
public class EHF010107M0F extends ActionForm implements ValidateForm {
	...
	private void saveData_validate(ActionErrors errors,
		...
		ve.isEmpty(errors, EHF000100T0_13_TAC, "EHF000100T0_13_TAC", "不可空白");	//電話(代表號)
		ve.isEmpty(errors, EHF000100T0_13_PN, "EHF000100T0_13_PN", "不可空白");
		
		if(!(EHF000100T0_14_TAC==null?"":EHF000100T0_14_TAC).equals("")){
			ve.isEmpty(errors, EHF000100T0_14_PN, "EHF000100T0_14_TAC", "電話號碼不可空白");
		}
		
		if(!(EHF000100T0_15_TAC==null?"":EHF000100T0_15_TAC).equals("")){
			ve.isEmpty(errors, EHF000100T0_15_PN, "EHF000100T0_15_TAC", "傳真號碼不可空白");
		}
		...
		if(matcher.find()) {
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司代碼請輸入英文加數字，且勿超過10碼!!");
		}
		
		//檢核字數
		if((!"".equals(getEHF000100T0_01())|| getEHF000100T0_01()==null) && !GenericValidator.maxLength(getEHF000100T0_01(), 10)){//
			errors.add("EHF000100T0_01", new ActionMessage(""));
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司代碼字數不得超過10個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_03())|| getEHF000100T0_03()==null) && !GenericValidator.maxLength(getEHF000100T0_03(), 20)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司名稱(中)字數不得超過20個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_04())|| getEHF000100T0_04()==null) && !GenericValidator.maxLength(getEHF000100T0_04(), 20)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司名稱(英)字數不得超過20個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_05())|| getEHF000100T0_05()==null) && !GenericValidator.maxLength(getEHF000100T0_05(), 50)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司簡稱字數不得超過50個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_07())|| getEHF000100T0_07()==null) && !GenericValidator.maxLength(getEHF000100T0_07(), 10)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"負責人字數不得超過10個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_08())|| getEHF000100T0_08()==null) && !GenericValidator.maxLength(getEHF000100T0_08(), 10)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"聯絡人字數不得超過10個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_09())|| getEHF000100T0_09()==null) && !GenericValidator.maxLength(getEHF000100T0_09(), 50)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"登記地址(中)字數不得超過50個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_10())|| getEHF000100T0_10()==null) && !GenericValidator.maxLength(getEHF000100T0_10(), 50)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"登記地址(英)字數不得超過50個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_11())|| getEHF000100T0_11()==null) && !GenericValidator.maxLength(getEHF000100T0_11(), 50)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"營業地址(中)字數不得超過50個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_12())|| getEHF000100T0_12()==null) && !GenericValidator.maxLength(getEHF000100T0_12(), 50)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"營業地址(英)字數不得超過50個字!!");
		}
		
		if((!"".equals(getEHF000100T0_16())|| getEHF000100T0_16()==null) && !GenericValidator.maxLength(getEHF000100T0_16(), 20)){//
			errors.add("EHF000100T0_16", new ActionMessage(""));
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"電子郵件字數不得超過20個字!!");
		}
		...
		if((!"".equals(getEHF000100T0_17())|| getEHF000100T0_17()==null) && !GenericValidator.maxLength(getEHF000100T0_17(), 100)){//
			...
			request.setAttribute("ERR_MSG", (request.getAttribute("ErrMSG")==null?"":request.getAttribute("ErrMSG")+"<br>")+"公司簡介字數不得超過100個字!!");
		}
