...
public class EHF010110 implements QueryFunction, EditFunction,
	...
	public EHF010110( String comp_id ){
	...
	public List queryData(Map queryCondMap) {
		...
		try{
			...
			" A.EHF010106T0_07, DATE_FORMAT(A.EHF010106T0_10, '%Y/%m/%d') AS EHF010106T0_10, A.EHF010106T0_13, " +
