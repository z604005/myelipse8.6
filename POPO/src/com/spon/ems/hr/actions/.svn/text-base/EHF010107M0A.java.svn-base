...
import com.spon.ems.hr.forms.EHF010107M0F;
import com.spon.ems.hr.models.EHF010107;

public class EHF010107M0A extends EditAction {
	
	protected boolean setFormTypeData(Connection conn, ActionForm form, Map paramMap){
		
		EHF010107M0F Form = (EHF010107M0F)form;
	...
	protected boolean executeSaveData(Connection conn, ActionForm form,
		...
		try{
			//建立EHF010107元件
			EHF010107 eef010107 = new EHF010107();
	...
	protected ActionForm executeInitData(Connection conn, ActionForm form,
		...
		EHF010107M0F Form = new EHF010107M0F();
		Form.setChangeFormType("init");
		
		try{
			Form = (EHF010107M0F)executeQueryData(conn, Form, paramMap).get("FORM");
	...
	protected Map executeQueryData(Connection conn, ActionForm form,
		...
		try{
			...
			queryCondMap = eef010107.queryEditData(queryCondMap);
