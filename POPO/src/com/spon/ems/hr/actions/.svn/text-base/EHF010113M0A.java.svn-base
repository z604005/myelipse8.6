...
import com.spon.ems.hr.forms.EHF010113M0F;
import com.spon.ems.hr.forms.EX010113R0F;
import com.spon.ems.hr.models.EHF010113;
import com.spon.utils.util.BA_TOOLS;
import com.sun.org.apache.commons.beanutils.BeanUtils;

public class EHF010113M0A extends QueryAction {
	...
	protected ActionForm executeInitData(Connection conn, ActionForm form,
		...
		EHF010113M0F Form = new EHF010113M0F();
		List list = new ArrayList();
		
		Form.setEHF010113M0_LIST(list);
	...
	protected Map executeQueryData(Connection conn, ActionForm form,
		...
		EHF010113M0F Form = (EHF010113M0F) form;
		Map return_map = new HashMap();
		EHF010113M0F bean = null;
		String comp_id = (String)paramMap.get(super.COMP_ID);
		
		try{
			//建立空清單
			List<EHF010113M0F> querylist = new ArrayList<EHF010113M0F>();
			
			//建立EHF010113元件
			EHF010113 ehf010113 = new EHF010113(comp_id);
			...
			//使用元件進行處理
			List ehf010113_queryList = ehf010113.queryData(queryCondMap);
			
			Iterator it = ehf010113_queryList.iterator();
			Map tempMap = null;
			...
			//設定querylist
			Form.setEHF010113M0_LIST(querylist);
	...
	public ActionForward print(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
    	...
    	try{
    		//產生Excel元件
			EX010113R0F ef = new EX010113R0F(conn,getServlet().getServletContext().getRealPath(""),getLoginUser(request).getUserId(),request);
    		   		
			int DataCount =0;
									
			// 列印報表表頭
			ef.printHeadValue("", "", tool.ymdTostring(tool.getSysDate())+ "", "思邦科技股份有限公司", "員工在職證明書");
			...
			if (DataCount > 0){//表示有資料
				...
				String name ="員工在職證明書"+cur_date+".xls";
