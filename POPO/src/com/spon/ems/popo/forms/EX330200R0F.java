...
public class EX330200R0F extends BA_EXCEL {
	 ...
	 * 
	 */
	public EX330200R0F(Connection conn, String rpt, String SC0030_01)
			throws Exception {

		// 樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
		super.TemplateName = "EHF330200R0.xls";

		// sheet的名稱
		super.SheetName = "餐點分類表";
	 ...
	 * 
	 */
	public EX330200R0F(Connection conn, String rpt, String SC0030_01,HttpServletRequest request) throws Exception {
