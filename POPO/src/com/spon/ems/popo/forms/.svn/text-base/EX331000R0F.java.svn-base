package com.spon.ems.popo.forms;
	 ...
	 */
	public class EX331000R0F extends BA_EXCEL {
		
		private int headsize = 15; //標題個數
		 ...
		 * 
		*/
		public EX331000R0F(Connection conn,String rpt,String SC0030_01) throws Exception{
				
			//樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
			super.TemplateName = "EHF331000R0.xls";
				
			//sheet的名稱
			super.SheetName = "當日已收明細表";
		 ...
		 * 
		 */
		public EX331000R0F(Connection conn,String rpt,String SC0030_01,HttpServletRequest request, int count) throws Exception{
