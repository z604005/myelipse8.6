...
public class EX331300R0F extends BA_EXCEL {
	...
	private int headsize = 12; //標題個數
		 ...
		 * 
		 */
	public EX331300R0F(Connection conn,String rpt,String SC0030_01,HttpServletRequest request) throws Exception{
			
			//樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
			super.TemplateName = "EHF331300R0.xls";
			
			//sheet的名稱
			super.SheetName = "用餐客戶明細報表";
				
			//樣板一頁總列數
			super.PageRowCount = 30;

			//樣板一頁可放資料筆數,不管一筆資料使用了幾列
			super.PageDataCount = 27;
