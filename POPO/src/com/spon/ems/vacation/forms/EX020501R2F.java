 ...
 *
 */
public class EX020501R2F extends BA_EXCEL {
...
private int headsize = 12; //標題個數
	 ...
	 * 
	 */
	public EX020501R2F(Connection conn,String rpt,String SC0030_01) throws Exception{
		
		//樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
		super.TemplateName = "EHF020501R2.xls";
		
		//sheet的名稱
		super.SheetName = "請假月報表";
...
//		super.PageColCount = 10;
	 ...
	 * 
	 */
public EX020501R2F(Connection conn,String rpt,String SC0030_01,HttpServletRequest request) throws Exception{
