 ...
 *@author maybe
 *@version 1.0
 *@created 2016/11/15 下午2:42:11
 */
public class EX020404R0F extends BA_EXCEL {
	 ...
	 * 
	*/
	public EX020404R0F(Connection conn,String rpt,String SC0030_01, int count) throws Exception{
			
		//樣版檔的名稱，注意此元件只能處理樣板上只有一個sheet
		super.TemplateName = "EHF020404R0_example.xls";
			
		//sheet的名稱
		super.SheetName = "門禁資料匯入";
...
//		super.PageColCount = 10;
	 ...
	 * 
	 */
	public EX020404R0F(Connection conn,String rpt,String SC0030_01,HttpServletRequest request, int count) throws Exception{
