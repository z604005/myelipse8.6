package com.spon.ems.abs.forms;
...
/**
 * <Form>思邦科技查詢抽象FormBean
 * @version 1.0
 * @created 25-四月-2011 下午 02:26:36
 */
public abstract class QueryForm extends ActionForm implements ValidateForm {
	
	private String DATA00;
	 ...
	 * @param o1
	 */
	protected ActionErrors base_validate(ActionMapping mapping,	HttpServletRequest request, Connection conn){
		...
		try{
			...
			//查詢時判斷條件
			if (request.getAttribute("action").equals("queryEditData")) {
				queryEditData_validate(l_actionErrors, request, conn);
			}
	...
	protected abstract void queryData_validate(ActionErrors errors, HttpServletRequest request, Connection conn);
	protected abstract void queryEditData_validate(ActionErrors errors, HttpServletRequest request, Connection conn);
	protected abstract void addData_validate(ActionErrors errors, HttpServletRequest request, Connection conn);
	protected abstract void saveData_validate(ActionErrors errors, HttpServletRequest request, Connection conn);
	protected abstract void delData_validate(ActionErrors errors, HttpServletRequest request, Connection conn);
