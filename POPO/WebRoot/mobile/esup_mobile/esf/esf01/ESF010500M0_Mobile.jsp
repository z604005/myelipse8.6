...
<%--        <div data-role="fieldcontain" >--%>
<%--        	<label for="ESF010300T0_11">廠商編號：</label>--%>
<%--        	<input type="hidden" class="ui-input-text" --%>
<%--            	   id="ESF010300T0_11" name="ESF010300T0_11" placeholder="請輸入廠商編號..." value="" />--%>
<%--            --%>
<%--        </div>--%>
<%--        <div data-role="fieldcontain" >--%>
<%--        	<label for="ESF010300T0_12">廠商名稱：</label>--%>
<%--        	<input type="text" class="ui-input-text" --%>
<%--            	   id="ESF010300T0_12" name="ESF010300T0_12" placeholder="請輸入廠商名稱..." value="" />--%>
<%--            --%>
<%--        </div>--%>
<%--        <div data-role="fieldcontain">--%>
<%--   			<label for="ESF010300T0_27" class="select">表單狀態：</label>--%>
<%--  				<select id="ESF010300T0_27" name="ESF010300T0_27" >--%>
