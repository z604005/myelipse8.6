...
<layout:form action="EHF300100M0.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="路線資料查詢">

	<layout:row>
		<logic:notEqual name="button" value="edit">
			<layout:image alt="查詢" mode="D,D,D" name="btnimage?text=button.query&type=t"
						  reqCode="queryForm" property="EHF300100M0" ></layout:image>
			<layout:image alt="新增" mode="D,D,H" name="btnimage?text=button.add&type=t"
						  reqCode="addDataForm" property="EHF300100M0" ></layout:image>
		</logic:notEqual>
		...
		<logic:equal name="button" value="query">
			<layout:image alt="修改" mode="H,D,H" name="btnimage?text=button.update&type=t"  
						  reqCode="editDataForm" property="EHF300100M0" ></layout:image>
		</logic:equal>
		<logic:equal name="button" value="query">
			<layout:image alt="刪除" mode="H,D,H" name="btnimage?text=button.delete&type=t" confirm="您確定要刪除資料嗎?"
				 		  reqCode="delForm" property="EHF300100M0" ></layout:image>
		</logic:equal>
	</layout:row>
	...
	<layout:grid cols="2" space="false" borderSpacing="1" align="left" styleClass="DATAGRID" width="100%" >
		...
		<layout:text styleClass="DATAS" key="路線名稱" property="EHF300100T0_02" styleId="EHF300100T0_02" size="16" mode="E,E,I" maxlength="10" name="Form1Datas" />
	...
	<%
		int item_index = 0;
		EHF300100M0F EHF300100m0f =(EHF300100M0F)request.getAttribute("Form1Datas");
		ArrayList list = (ArrayList) EHF300100m0f.getEHF300100T0_LIST();
		String strTmp = "";
	...
	<layout:pager sessionPagerId="Pageid"  linksLocation="both" width="100%" maxPageItems="15" >
		...
		<layout:collection emptyKey="沒有資料列" name="Form1Datas" property="EHF300100T0_LIST" id="bean1" indexId="index" selectId="" selectProperty="" selectName="" 
			...
			<layout:collectionItem name="bean1" title="選取">
				...
				if (item_index < list.size()){
					...
					EHF300100M0F FORM=(EHF300100M0F)list.get(i);
					strTmp = FORM.getEHF300100T0_01();					
					item_index++;
				%>
			...
			<layout:collectionItem property="EHF300100T0_02" style="TEXT-ALIGN: CENTER" title="路線名稱" />
			<layout:collectionItem property="EHF300100T0_04_TXT" style="TEXT-ALIGN: CENTER" title="啟用" />
			<layout:collectionItem property="EHF300100T0_05" style="TEXT-ALIGN: CENTER" title="備註" />
