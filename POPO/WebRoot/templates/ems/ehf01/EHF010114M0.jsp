...
<%@ page import="com.spon.ems.hr.forms.EHF010114M0F" %>
...
<layout:form action="EHF010114M0.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="員工離職證明 ">
...
<%--					  reqCode="print2" alert="報表列印中!! 請勿重複執行!!" ></layout:image>--%>
		<layout:image alt="列印" mode="D,D,D" name="btnimage?text=button.print&type=t" property="EHF010114M0" 
...
<%--		</logic:equal>				--%>
	...
	<logic:equal name="collection" value="show">
		...
		<layout:pager sessionPagerId="Pageid"  linksLocation="both" width="100%" maxPageItems="15" >
			...
			<layout:collection emptyKey="沒有資料列"  name="Form1Datas" property="EHF010114M0_LIST" selectId="" selectProperty="" selectName=""  
				...
				<layout:collectionItem property="EHF010106T0_01" style="TEXT-ALIGN: CENTER" title="身分證明編號"/>
				<layout:collectionItem property="EHF010106T1_02_take" style="TEXT-ALIGN: CENTER" title="到職日"/>
				<layout:collectionItem property="EHF010106T1_02_leave" style="TEXT-ALIGN: CENTER" title="離職日"/>		
			</layout:collection>
