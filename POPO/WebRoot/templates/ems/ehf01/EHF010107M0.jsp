...
<layout:form action="EHF010107M0.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="公司基本資料">

	<layout:row>
<%--		<logic:equal name="button" value="edit">--%>
			<layout:image alt="儲存" mode="D,D,H" name="btnimage?text=button.save&type=t"  reqCode="saveDataForm" property="EHF010107M0" 
						  onclick="document.getElementById('changeFormType').value='save'" ></layout:image>
			<layout:image alt="修改" mode="H,H,D" name="btnimage?text=button.update&type=t"  reqCode="changeForm" property="EHF010107M0" 
						  onclick="document.getElementById('changeFormType').value='edit'" ></layout:image>			
<%--		</logic:equal>--%>
...
<%--		</logic:equal>--%>
	...
	<layout:grid cols="2" space="false" borderSpacing="1" align="left" styleClass="DATAGRID" width="100%">
		...
		<layout:date calendarType="datepicker" startYear="2012" endYear="2020" patternKey="yy/mm/dd" tooltip="成立日期" key="成立日期" size="10"
		...
		<layout:text styleClass="DATAS" tooltip="電子郵件" key="電子郵件" property="EHF000100T0_16" styleId="EHF000100T0_16" size="16" 
				 	 maxlength="50" mode="E,E,I" name="Form1Datas" />		 	 
