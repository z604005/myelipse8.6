...
<layout:form action="EHF010108M1.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="部門基本資料">

	<layout:row>
		<logic:notEqual name="button" value="edit">
			<layout:image alt="確認新增" mode="D,H,D" name="btnimage?text=button.add.ok&type=t"  reqCode="addDataForm" property="EHF010108M1" ></layout:image>
			<layout:image alt="儲存" mode="H,D,D" name="btnimage?text=button.save&type=t" reqCode="saveDataForm" property="EHF010108M1" ></layout:image>
		</logic:notEqual>
		<logic:equal name="button" value="query">
			<layout:image alt="刪除" mode="H,D,D" name="btnimage?text=button.delete&type=t" confirm="您確定要刪除資料嗎?"
				 		  reqCode="delForm" property="EHF010108M1" ></layout:image>
		</logic:equal>
		<layout:image alt="回前作業" mode="D,D,D" name="btnimage?text=button.Back&type=t"  reqCode="redirect" property="EHF010108M1" ></layout:image>
    </layout:row>
	...
	<layout:grid cols="2" space="false" borderSpacing="1" align="left" styleClass="DATAGRID" width="100%" >
		...
		<layout:text styleClass="DATAS" property="HR_DepartmentSysNo" styleId="HR_DepartmentSysNo" size="20" mode="H,H,H" maxlength="20" name="Form1Datas" />
		<layout:text styleClass="DATAS" key="部門代碼" property="HR_DepartmentNo" styleId="HR_DepartmentNo" size="20" mode="E,E,I" maxlength="200" name="Form1Datas" />
		...
		<layout:text styleClass="DATAS" key="部門簡稱" property="EHF010108T0_01" styleId="EHF010108T0_01" size="20" mode="E,E,I" maxlength="20" name="Form1Datas" />
	...
	<layout:grid cols="1" space="false" borderSpacing="1" align="left" styleClass="DATAGRID" width="100%" >
		<layout:text styleClass="DATAS" key="部門簡介" property="EHF010108T0_04" styleId="EHF010108T0_04" size="50" mode="E,E,I" maxlength="50" name="Form1Datas" />
	</layout:grid>
<%--	<layout:grid cols="2" space="false" borderSpacing="1" align="left" styleClass="DATAGRID" width="100%" >--%>
...
<%--		</layout:cell>--%>
<%--	</layout:grid>--%>
	<layout:collection emptyKey="沒有資訊列" name="Form1Datas" property="EHF010108T0_LIST" id="bean1" indexId="index" width="100%" styleClass="COLLECTION" styleClass2="COLLECTION_2" >
...
<%--			onclick="return confirmShowEMSWait('您確定要刪除此筆明細嗎?');" >刪除</layout:collectionItem>					--%>
		<layout:collectionItem property="HR_DepartmentNo" title="下層部門代號" style="text-align: center" />
		<layout:collectionItem property="HR_DepartmentName" title="下層部門名稱" style="text-align: center" />
	</layout:collection>
