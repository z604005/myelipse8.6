...
<%@ page import="com.spon.ems.hr.forms.EHF010111M0F" %>
...
<layout:form action="EHF010111M0.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="員工通訊錄">
...
<%--					  reqCode="print2" alert="報表列印中!! 請勿重複執行!!" ></layout:image>--%>
		<layout:image alt="列印" mode="D,D,D" name="btnimage?text=button.print&type=t" property="EHF010111M0" 
...
<%--		</logic:equal>				--%>
	...
	<logic:equal name="collection" value="show">
		...
		<layout:pager sessionPagerId="Pageid"  linksLocation="both" width="100%" maxPageItems="15" >
			...
			<layout:collection emptyKey="沒有資料列"  name="Form1Datas" property="EHF010111M0_LIST" selectId="" selectProperty="" selectName=""  
				...
				<layout:collectionItem property="EHF010106T0_13" style="TEXT-ALIGN: CENTER" title="聯絡電話"/>
				<layout:collectionItem property="EHF010106T0_15" style="TEXT-ALIGN: CENTER" title="手機號碼"/>		
			</layout:collection>
