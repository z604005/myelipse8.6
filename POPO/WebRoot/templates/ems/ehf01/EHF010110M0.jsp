...
<%@ page import="com.spon.ems.hr.forms.EHF010110M0F" %>
...
<layout:form action="EHF010110M0.do" reqCode="" width="100%" styleClass="TITLE" method="post" key="員工基本資料卡 ">
...
<%--					  reqCode="print2" alert="報表列印中!! 請勿重複執行!!" ></layout:image>--%>
		<layout:image alt="列印" mode="D,D,D" name="btnimage?text=button.print&type=t" property="EHF010110M0" 
...
<%--		</logic:equal>				--%>
	...
	<logic:equal name="collection" value="show">
		...
		<layout:pager sessionPagerId="Pageid"  linksLocation="both" width="100%" maxPageItems="15" >
			...
			<layout:collection emptyKey="沒有資料列"  name="Form1Datas" property="EHF010110M0_LIST" selectId="" selectProperty="" selectName=""  
...
<%--				<layout:collectionItem property="HR_JobName" style="TEXT-ALIGN: CENTER" title="員工職稱" />				--%>
				...
				<layout:collectionItem property="EHF010106T0_07" style="TEXT-ALIGN: CENTER" title="性別"/>
				<layout:collectionItem property="EHF010106T0_13" style="TEXT-ALIGN: CENTER" title="連絡電話"/>		
			</layout:collection>
